...
class applandCatalog extends applandConfig {
     ...
     */
    private $url = array(
        'list'=>'http://feed.appland.se/api/feed/c/listV2/store/TFC/start/{START}/count/{PAGE_SIZE}/p/simpleListV1/tfcListV1/a/tfc/{SECRET}',
        'detail'=>'http://feed.appland.se/api/feed/c/detailV2/store/TFC/id/{ITEM_ID}/p/clone/a/tfc/{SECRET}',
        'listDetail'=>'http://feed.appland.se/api/feed/c/listDetailV2/store/TFC/sort/1/start/{START}/count/{PAGE_SIZE}/p/simpleListV1/imageUriFullSizeV1/tfcListV1/a/tfc/{SECRET}',
    );
    ...
    private function newApp($data)
    {
        ...
        try {
            ...
            $this->product->get($data['appId'], false);
            $this->product->setProviderProductId($data['appId'])
